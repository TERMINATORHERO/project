...
namespace VACEfron.NET
{
    internal static class RequestFunctions
    {
        ...
        internal static MemoryStream ImageRequest(string endpoint)
        {
            ...
            var getRequest = httpClient.GetAsync("https://welcomer12.herokuapp.com/" + endpoint, HttpCompletionOption.ResponseContentRead);
        ...
        internal static JObject MakeWebRequest(string endpoint)
        {
            ...
            var responseMessage = httpClient.GetAsync($"https://welcomer12.herokuapp.com/{endpoint}");
